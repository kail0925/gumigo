...
def start_reload():
    ...
    if current_weapon == WEAPON_PISTOL and current_pistol_ammo < max_pistol_ammo:
        ...
        is_reloading = True
        reload_end = pygame.time.get_ticks() + 4000
...
while True:
    ...
    if game_state == STATE_PLAYING:
        ...
        if not player_dead:
            ...
            is_sprinting = keys[pygame.K_LSHIFT] and player_stamina > 0 and not is_aiming
            speed = (player_speed * 1.5 if is_sprinting else player_speed) * time_scale
            ...
            for item in items[:]:
                ...
                if dist < 40:
                    ...
                    if item['type'] == 'ak':
                        ...
                        shotgun_reserve_ammo += 20; msg = "샷건 탄약 획득 (+20발)"; msg_color = RED
                    elif item['type'] == 'health':
                        player_health = min(100.0, player_health + 25); msg = "체력 회복 (+25)"; msg_color = GREEN; heal_effect_timer = 40
                ...
                for enemy in enemies:
                    ...
                    if dist < 2000:
                        if dist > 35:
                            ...
                            move_x = fdx * enemy['speed'] * time_scale
                            move_y = fdy * enemy['speed'] * time_scale
